...
void click_handler(t_data *data)
{
    ...
    if (x > 841 && y > 130 && x < 891 && y < 180 && data->mouse.click == 1 && data->mouse.sensitivity < 1)
            data->mouse.sensitivity += 0.01;
    if (x > 605 && y > 130 && x < 640 && y < 180 && data->mouse.click == 1 && data->mouse.sensitivity > 0.01)
            data->mouse.sensitivity -= 0.01;
    if (x > 841 && y > 330 && x < 891 && y < 380 && data->player.speed < 0.1 && data->mouse.click == 1)
            data->player.speed += 0.001;
    if (x > 605 && y > 330 && x < 650 && y < 380 && data->player.speed > 0 && data->mouse.click == 1)
            data->player.speed -= 0.001;
